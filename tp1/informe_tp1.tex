...
\figureorplaceholder{figuras/rmse.png}{0.65}{RMSE de la distribución acumulada respecto de la distribución final.}

\paragraph{Resultado.} La distribución se estabilizó aproximadamente a partir de 500 proteínas. Por lo tanto, se utilizó una muestra de 1000 proteínas para obtener una estimación estable y conservadora.
...
\figureorplaceholder{figuras/clasificador_orfs.png}{0.65}{Distribuciones aprendidas por el clasificador y probabilidades posteriores de los ORFs encontrados.}
